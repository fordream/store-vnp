...
import com.cnc.buddyup.response.ResponseSkillLevel;
import com.cnc.buddyup.response.item.SkillLevel;

public class SkillLevelWheelActivity extends Activity implements
		OnClickListener {
	...
	private ResponseSkillLevel responseSkillLevel;
	...
	private class AsynAge extends AsyncTask<String, String, String> {
		private ResponseSkillLevel responseAge;

		protected String doInBackground(String... params) {
			RequestSkillLevel requestAge = new RequestSkillLevel();
			responseAge = ResponseSkillLevel.getData(requestAge);
	...
	public void updateCities1(ResponseSkillLevel responseAge) {
