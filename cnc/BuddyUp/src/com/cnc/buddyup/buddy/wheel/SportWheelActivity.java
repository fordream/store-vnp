package com.cnc.buddyup.buddy.wheel;
...
public class SportWheelActivity extends Activity implements OnClickListener {
	private WheelView city;
	private String cities1[] = new String[] { "Alpine Skling", "Backpacking","Golf","Hiking",
			 };
