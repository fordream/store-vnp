...
public class PendingActivityView extends LinearLayout {
	protected Handler handler;
	private CommonListView commonList;

	public PendingActivityView(Context context, AttributeSet attrs,
			Handler handler) {
	...
	public PendingActivityView(Context context, Handler handler) {
	...
	public void config(int resLayout) {
		...
		// add Data temp
		setListparcelable(Common.createListparcel(5));
	}
}