	...
	public static String executeHttpGet() {
		...
		try {
			request.setURI(new URI(
					"http://connectsoftware.com/mapi/login?format=xml&email=vuongvantruong1987%40gmail.com&password=1&submit=Submit+Query"));
