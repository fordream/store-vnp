...
public class GenericProductsViewControl extends CommonHomeViewControl {

	public GenericProductsViewControl(Context context,Product product) {
...
//	
//	public GenericProductsViewControl(Context context) {
//		super(context);
