...
public class DataHistory2BaseHelper extends SQLiteOpenHelper {
	// org.cnc.qrcode
	// com.google.zxing.client.android
	private static String DB_PATH = "/data/data/org.cnc.qrcode/databases/";
	private static String DB_NAME = "history2.sqlite";
	private SQLiteDatabase myDataBase;
	private final Context myContext;

	public DataHistory2BaseHelper(Context context) {
