 ...
 * @since 10/2011
 */
public class FeaturedListAdapter extends BaseAdapter implements Const {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.divider = (TextView) convertView
					.findViewById(R.id.feature_listitem_divider);
		...
		if (obj instanceof Artist) {
			...
			if (video.price.length() == 0) {
				...
				holder.second_info
						.setText(String.format(
								mContext.getString(R.string.format_price),
								video.price));
			}
			...
			mImageLoader.DisplayImage(album.coverUrl, mContext, holder.icon,
			...
			mImageLoader.DisplayImage(news.thumbUrl, mContext, holder.icon,
					ImageLoader.TYPE_SONG);
			...
			if (isLocalMusic) {
				holder.first_info.setVisibility(TextView.GONE);
				...
				holder.first_info.setVisibility(TextView.VISIBLE);
