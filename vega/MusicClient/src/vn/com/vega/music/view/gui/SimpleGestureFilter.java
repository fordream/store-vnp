...
public class SimpleGestureFilter extends SimpleOnGestureListener {
	...
	private ViewFlipper context;
	private GestureDetector detector;
	private SimpleGestureListener listener;

	public SimpleGestureFilter(ViewFlipper _context, SimpleGestureListener sgl) {

		this.context = _context;
		this.detector = new GestureDetector(context.getContext(), this);
		this.listener = sgl;
	}
