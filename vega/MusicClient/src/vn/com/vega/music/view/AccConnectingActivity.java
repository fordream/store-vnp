...
public class AccConnectingActivity extends Activity {
		...
		public void onComplete(Bundle values) {
			...
			mHandler.post(new Runnable() {
				public void run() {
	                ...
	                params.putString("caption", "Chacha cloud");
	                params.putString("description", "Rạp hát di động");
	                params.putString("picture", "");
	                params.putString("name", "Testing");
	                params.putString("message", "Testing");

	                mFacebook.dialog(mContext, "feed", params, new UpdateStatusListener());
     ...
     */
    public class UpdateStatusListener implements com.facebook.android.Facebook.DialogListener {
        @Override
        public void onComplete(Bundle values) {
            final String postId = values.getString("post_id");
            if (postId != null) {
            	Toast toast = Toast.makeText(mContext, "Wall post made",
                        Toast.LENGTH_SHORT);
            	toast.show();
            } else {
