...
public interface Const {
	...
	public static final String BUNDLE_STACK_TYPE = "Stack type";
	public static final String BUNDLE_IS_FROM_ARTIST = "Is from artist";
	...
	public static final String KEY_IS_SHARING = "Is sharing";
	public static final String KEY_SHARE_TYPE = "Share type";
	public static final String KEY_SHARE_VALUE = "Share value";
	public static final String KEY_TEMP_PHONE_NUMBER = "Temp phone number";
	...
	public static final String FACEBOOK_APP_ID = "235697796486076";
	...
	public static final int TYPE_SEARCH_STACK = 0;
	public static final int TYPE_FEATURE_STACK = 1;
	public static final int TYPE_PLAYLIST_STACK = 2;
	public static final int TYPE_NOW_PLAYING_STACK = 3;
	...
	public static final int FRIEND_MODE_DEFAULT = 1;
	public static final int FRIEND_MODE_FIND_USER = 2;
	public static final int FRIEND_MODE_INVITE_FRIEND = 3;
	public static final int FRIEND_MODE_SHARE = 4;
	
	// music quality
	public static final String MUSIC_QUALITY_ID = "MUSIC_QUALITY_ID";
	public static final String MUSIC_QUALITY_VALUE = "MUSIC_QUALITY_VALUE";
}
