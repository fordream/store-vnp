...
public class PullToRefreshListView extends ListView {
	...
	private void init() {
		...
		text = (TextView) header.findViewById(R.id.pull_title);
		image = (ImageView) header.findViewById(R.id.pull_image);
		spinner = (ProgressBar) header.findViewById(R.id.pull_spinner);
	...
	private void bounceBackHeader() {
		...
		bounceAnimation = new TranslateAnimation(TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0, TranslateAnimation.ABSOLUTE, 0,
