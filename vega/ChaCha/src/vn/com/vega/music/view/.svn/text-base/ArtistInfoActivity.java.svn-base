...
public class ArtistInfoActivity extends Activity implements Const, AutoLoadingListener, OnClickListener {
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		if (songListAdapter != null) {
			...
			if (notInGroup)
				contextMenu.showOptionalDialog(song, ArtistInfoActivity.this, ContextMenuEx.TYPE_NORMAL);
			else
				contextMenu.showOptionalDialog(song, ArtistInfoActivity.this.getParent(), ContextMenuEx.TYPE_NORMAL);
		}
	};
	...
	private void setListAdapter(List<Object> objs) {
		...
		case R.id.artist_tab_song:
			...
			if (songListAdapter == null) {
				songListAdapter = new SongListAdapter(ArtistInfoActivity.this, objs, false);
				setAdapter(songListAdapter);
