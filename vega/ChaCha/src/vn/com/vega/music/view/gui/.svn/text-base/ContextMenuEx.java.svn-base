...
public class ContextMenuEx {
			...
			if (mSong.isLocalSong()) {
				...
				case 1:
					...
					if (_favPlaylist == null) {
						...
						if (_favPlaylist.getSongList().contains(mSong)) {
				...
				case 3:
					...
					// "You have just clicked share function",
					// Toast.LENGTH_SHORT).show();
	...
	public void showOptionalDialog(final Song _song, Context _context, int _type) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			case 1:
				...
				if (_favPlaylist == null) {
					...
					if (!_favPlaylist.getSongList().contains(_currSong)) {
						holder.first_text
								.setText(R.string.common_context_menu_like);
						holder.image
								.setBackgroundResource(R.drawable.ic_dialog_like);
