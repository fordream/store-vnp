...
public class LocalMusicActivity extends AbstractSongAcitivity implements Const {
	...
	public void setSelectedTab(int value) {
		...
		SharedPreferences sp = this
				.getSharedPreferences("SELECTED_TAB",
	...
	public int getSelectedTab() {
		...
		sp = getSharedPreferences(
				"SELECTED_TAB", Activity.MODE_PRIVATE);

		return sp.getInt("SELECTED_TAB",
				SONG_TAB);
	...
	private void showGenreTab() {
		if (genreListAdapter == null) {
			...
			if (objs.size() > 0)
				...
				helpLayout.setVisibility(LinearLayout.VISIBLE);
			genreListAdapter = new FeaturedListAdapter(LocalMusicActivity.this,
					objs, true);
		}
