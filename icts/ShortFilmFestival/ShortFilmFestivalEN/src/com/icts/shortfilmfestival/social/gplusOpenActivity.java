...
public class gplusOpenActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mUrlShare = getIntent().getStringExtra("URL");
		Log.d(TAG, mUrlShare);
		...
		mWebview.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				if(failingUrl.equals(mUrlShare)){
					Toast.makeText(gplusOpenActivity.this, description, Toast.LENGTH_SHORT).show();
				}
		...
		mWebview.setWebViewClient(new WebViewClient() {
	            ...
	            public void onLoadResource (WebView view, String url) {
	            	  if (mProgressDialog == null) {
		                	mProgressDialog = new ProgressDialog(gplusOpenActivity.this);
