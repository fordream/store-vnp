...
import com.icts.shortfilmfestival.fragment.PhotoDetail;
...
public class SmartImageViewPhoto extends ImageView {
	...
	public SmartImageViewPhoto(Context context) {
		super(context);
		// sharedConstructing(context);
	}

	public SmartImageViewPhoto(Context context, AttributeSet attrs) {
		super(context, attrs);
		// sharedConstructing(context);
	}

	public SmartImageViewPhoto(Context context, AttributeSet attrs, int defStyle) {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_MOVE:
					if (event.getPointerCount() == 1) {
						if (SmartImageViewPhoto.this.getScale() == 1 && pX >= 0) {
							Log.d("LOG_PHOTO_DETAIL", "ACTION_MOVE "
									+ (event.getX() - pX));
							if (event.getX() - pX <= -150) {
								PhotoDetail.transformImage(1);
								pX = -1;
							} else if (event.getX() - pX >= 150) {
								PhotoDetail.transformImage(0);
								pX = -1;
							}
	...
	private class ScaleListener extends
		...
		public boolean onScale(ScaleGestureDetector detector) {
			...
			if (origWidth * saveScale <= width
				...
				matrix.postScale(mScaleFactor, mScaleFactor, detector
