...
import com.caferhythm.csn.activity.ConfirmAlarmActivity2;
...
public class TimeAlarm2 extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		PendingIntent contentIntent = PendingIntent.getActivity(context, 0,
				new Intent(context,ConfirmAlarmActivity2.class), 0);
		...
		*/
		...
		Intent alarmScreenIntent = new Intent(context,ConfirmAlarmActivity2.class);  
