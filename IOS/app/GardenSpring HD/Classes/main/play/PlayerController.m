...
-(void)gameLogic2{
	...
	if(uiImageVIew1 != nil){
		...
		if(uiImageVIew1.center.x + w /2 <= 0 
		   ||uiImageVIew1.center.x - w /2 >= 1024
		   ||uiImageVIew1.center.y + h /2 <= 0 
		   || uiImageVIew1.center.y - h /2 >= 780){
			if(arc4random() % 100 < 5){
		...
		if(uiImageVIew1.center.x - 5 < pNext.x && pNext.x < uiImageVIew1.center.x + 5 
		   && pNext.y < uiImageVIew1.center.y + 5 && pNext.y > uiImageVIew1.center.y - 5){
			pNext.x = arc4random() % 1224 - 30;
			pNext.y = arc4random() % 100 - 30;
	...
	if(uiImageVIew1 == nil){
		...
		if(ran == 3 || ran == 4){
			...
			if(0 <= pNext.x && pNext.y <= 1024 
			   &&0 <= pNext.y && pNext.y <= 800){
