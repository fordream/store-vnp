...
-(IBAction) buttonPressed:(id)sender{
	...
	if(sender == btnNewGame){
		...
		//UIViewController *detailViewController = [self.detailViewControllers objectAtIndex:row];
		...
		UINavigationController *nav=[[[UINavigationController alloc]initWithRootViewController:_view0] autorelease];
		...
		UINavigationController *nav=[[[UINavigationController alloc]initWithRootViewController:_view1] autorelease];
		[self presentModalViewController:nav animated:YES];
		...
		UINavigationController *nav=[[[UINavigationController alloc]initWithRootViewController:_view4] autorelease];
		[self presentModalViewController:nav animated:YES];
	}
}
