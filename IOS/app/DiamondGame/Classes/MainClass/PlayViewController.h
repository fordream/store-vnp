...
@interface PlayViewController : UIViewController {
	...
	//tvuong1 add
	Point1 *board[SIZE8][SIZE8];
	UIButton * boardButton[SIZE8][SIZE8];
	UIImageView *boardImage[SIZE8][SIZE8];
...
///
-(NSMutableArray *)canGrow1 :(Point1 *)p;
-(NSMutableArray *)canGrow2 :(Point1 *)p P1:(Point1*) p1 P2:(Point1 *)p2;
