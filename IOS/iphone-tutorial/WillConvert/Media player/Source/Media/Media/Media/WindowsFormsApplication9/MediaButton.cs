#region Author/About
    ...
    *  MediaButton v1.1                                                                 *
    *                                                                                   *
    *  Created:     Januray 14, 2010                                                    *
    *  Built on:    Win7                                                                *
    *  Purpose:     Animated button control                                             *
    *  Revision:    1.1                                                                 *
    *  IDE:         C# 2008 SP1                                                         *
    ...
    *************************************************************************************
    ...
    v1.1
    Adjusted bottom glow position
    Added timer clause to swirl timer that sets speed based on image size 
    -(64x is recommended min image size on menu style)
    Tweaked swish timer
    Fixed a focus/hover repaint issue w/ custom style
    Fixed focused forecolor issue
*/
#endregion
