...
//		btnFacebook = (Button) findViewById(R.id.button2);
//		btnFacebook.setOnClickListener(new OnClickListener() {
//
//			@Override
//			public void onClick(View v) {
//				if (facebook.getAccessToken() == null)
//					facebook.authorize(AuthActivity.this, new DialogListener() {
//
//						@Override
...
//		});
//
//		app = new TwitterApp(this, CONSUMER_KEY, CONSUMER_SECRET);
//		app.setListener(new TwDialogListener() {
//
//			@Override
