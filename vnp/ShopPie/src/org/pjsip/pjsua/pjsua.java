...
public class pjsua implements pjsuaConstants {
  ...
  public static int csipsimple_init_acc_msg_data(int acc_id, pjsua_msg_data msg_data) {
    return pjsuaJNI.csipsimple_init_acc_msg_data(acc_id, pjsua_msg_data.getCPtr(msg_data), msg_data);
  }
  ...
  public static int call_recording_start(int call_id, pj_str_t file, int stereo) {
    return pjsuaJNI.call_recording_start(call_id, pj_str_t.getCPtr(file), file, stereo);
  }

  public static int call_recording_stop(int call_id) {
    return pjsuaJNI.call_recording_stop(call_id);
  }

  public static int call_recording_status(int call_id) {
    return pjsuaJNI.call_recording_status(call_id);
  }
