 ...
 * 
 */
package net.obviam.walking.surfaceview;

import net.obviam.walking.R;
import net.obviam.walking.R.drawable;
import net.obviam.walking.model.ElaineAnimated;
import net.obviam.walking.thread.MainThread;
...
public class MainGamePanel extends SurfaceView implements
	...
	public MainGamePanel(Context context) {
		...
		elaine = new ElaineAnimated(BitmapFactory.decodeResource(
				getResources(), R.drawable.walk_elaine), 10, 50 // initial
